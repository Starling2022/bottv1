...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  if(event.type == "message_reply") { uid = event.messageReply.senderID }
    ...
    const res = await axios.get(`https://api.leanhtruong.net/v2/info_user_facebook.php?api_key=LEANHTRUONG=BHmPjgQToD80SCCAtgJO1ZKzm9IZytClnM1avO14hPkRB4Sk4T=APIKEY=PLANFREE&id=${uid}`); 
