...
module.exports.run = async({api,event,args}) => {
    ...
    if (args[0] == "admin","ad") {
    let data = await api.getUserInfo(100004434344115);
    let url = data[100004434344115].profileUrl;
    let b = data[100004434344115].isFriend == false ? "không !" : data[100004434344115].isFriend == true ? "có !" : "Đéo";
    let sn = data[100004434344115].vanity;
    let name = await data[100004434344115].name;
    var sex = await data[100004434344115].gender;
...
👉 Contact: Https://NguyenHoangAnhProCoder.github.io/Profile`,
    ...
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100004434344115}/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)).pipe(
